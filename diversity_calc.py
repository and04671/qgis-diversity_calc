...
/***************************************************************************
 DiversityCalc
                                 A QGIS plugin
 Calculates biodiversity indices (Richness, Shannons, Simpsons)
...
from diverty_functions import dc_summarizePoly, dc_mergeDictionaries, dc_resultString
import os.path
...
class DiversityCalc:
    ...
    def run(self):
        ...
        if result:
            # get required inputs from dialog
